      ...
      <li>
        <details>
          ...
          <ul class="bg-base-100 rounded-t-none p-2">
            <li><a href="https://yaylabs.dev/">About Us</a></li>
            <li><a href="https://www.yaycompany.com">The Yay Company</a></li>
          </ul>
        </details>
      </li>
    </ul>
